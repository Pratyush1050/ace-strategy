...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $countries = [
            ...
            ['label' => 'Turks and Caicos Islands', 'country_code' => '+1-649', 'iso_code' => 'TC'],
        ...
        foreach($countries as $country)
        {
            ...
            $newCountry->label = $country['label'];
            $newCountry->country_code = $country['country_code'];
            $newCountry->iso_code = $country['iso_code'];
            $newCountry->save();
        }
    }
}
